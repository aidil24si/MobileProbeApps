package com.example.probeapps.Message.Tutorial
...
import com.example.probeapps.databinding.ActivityNinthBinding
import com.example.probeapps.databinding.ActivityTutorialMessageBinding
...
class TutorialMessageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tutorial_message)
